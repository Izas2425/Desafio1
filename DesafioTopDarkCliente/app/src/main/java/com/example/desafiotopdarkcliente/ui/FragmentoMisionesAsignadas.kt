...
class FragmentoMisionesAsignadas : Fragment() {
    ...
    private val viewModel: FragmentoMisionesAsignadasViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_fragmento_misiones_asignadas, container, false)
    }
}