...
class FragmentoMisionesNoSuperadasViewModel : ViewModel() {
    ...
    fun getMisionesNoSuperadasVM(id: Int) {
        viewModelScope.launch {
            _isLoading.value = true
            var response: Response<MutableList<Misionasignada>> = UserNetwork.retrofitMisionAsignada.getMisionesasignadasNoSuperadas(id)
