...
class FragmentoMisionesSuperadasViewModel : ViewModel() {
    ...
    fun getMisionesSuperadasVM(id: Int) {
        viewModelScope.launch {
            _isLoading.value = true
            var response: Response<MutableList<Misionasignada>> = UserNetwork.retrofitMisionAsignada.getMisionesasignadasSuperadas(id)
